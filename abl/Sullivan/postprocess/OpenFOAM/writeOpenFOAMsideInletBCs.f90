...
program writeOpenFOAMBCs
  ...
  open(unit=11,file="sideInlet/points")
  write(11,*)"/*--------------------------------*- C++ -*----------------------------------*\ "
  write(11,*)"| =========                 |                                                 | "
  ...
  do fileCounter=1678,nt+1678
     ...
     call system("mkdir "//"sideInlet/"//trim(adjustl(command)))
     open(unit=11,file="sideInlet/"//trim(adjustl(command))//"/U")
     write(11,*)"/*--------------------------------*- C++ -*----------------------------------*\ "
     write(11,*)"| =========                 |                                                 | "
     write(11,*)"| \\      /  F ield         | OpenFOAM: The Open Source CFD Toolbox           | "
     write(11,*)"|  \\    /   O peration     | Version:  1.6                                   | "
     ...
     open(unit=11,file="sideInlet/"//trim(adjustl(command))//"/T")
     write(11,*)"/*--------------------------------*- C++ -*----------------------------------*\ "
     write(11,*)"| =========                 |                                                 | "
     write(11,*)"| \\      /  F ield         | OpenFOAM: The Open Source CFD Toolbox           | "
     write(11,*)"|  \\    /   O peration     | Version:  1.6                                   | "
     ...
     open(unit=11,file="sideInlet/"//trim(adjustl(command))//"/k")
     write(11,*)"/*--------------------------------*- C++ -*----------------------------------*\ "
     write(11,*)"| =========                 |                                                 | "
     write(11,*)"| \\      /  F ield         | OpenFOAM: The Open Source CFD Toolbox           | "
     write(11,*)"|  \\    /   O peration     | Version:  1.6                                   | "
